...
public class VideosFragment extends Fragment {
    ...
    private void prepareMovieData() {
        ...
        myModel = new MyModel(R.mipmap.chainsmoker3_bg, getResources().getString(R.string.title1),
                getResources().getString(R.string.time3), getResources().getString(R.string.desc_text));
        mySongList.add(myModel);
        ...
        myModel = new MyModel(R.mipmap.chainsmoker2_bg, getResources().getString(R.string.title2),
                getResources().getString(R.string.time3), getResources().getString(R.string.desc_text));
        mySongList.add(myModel);

        myModel = new MyModel(R.mipmap.chainsmokerbg, getResources().getString(R.string.title1),
                getResources().getString(R.string.time3), getResources().getString(R.string.desc_text));
        mySongList.add(myModel);
